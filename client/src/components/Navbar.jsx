          ...
          <div className="flex items-center justify-between h-16 sm:h-20 gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              {isAdmin && (
                <Link
                  to="/admin/dashboard"
                  className="hidden md:flex px-3 py-2 rounded-2xl text-xs font-bold bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 border border-amber-500/30 transition items-center gap-1.5"
                >
                  <span>⚙️</span> Admin
                </Link>
              )}
